...
import { X, Save, Edit3, Microscope, Calendar, CheckCircle, AlertCircle, Link, FileText, ExternalLink } from 'lucide-react';
...
export default function EquipmentCardModal({ isOpen, onClose, equipment, onSave }) {
    ...
    <div style={{
      ...
      >
        ...
        <form onSubmit={handleSubmit} style={{ padding: '32px' }}>
            ...
            <div>
              ...
              <div className="input-group">
                ...
                >
                  ...
                  <option value="HSLAB Baleares - Consultores">Equipo de Consultores (Externo)</option>
                </select>
              </div>
              ...
              <div className="input-group">
                ...
                <datalist id="subtype-list">
                  {formData.macro_category && SUBCATEGORIES[formData.macro_category] 
                    ? SUBCATEGORIES[formData.macro_category].map(sub => <option key={sub} value={sub} />)
                    : Object.values(SUBCATEGORIES).flat().map(sub => <option key={sub} value={sub} />)
                  }
                </datalist>
              </div>
          ...
          <div style={{ borderTop: '1px solid var(--border)', paddingTop: '24px', marginTop: '32px', display: 'flex', justifyContent: 'flex-end', gap: '16px' }}>

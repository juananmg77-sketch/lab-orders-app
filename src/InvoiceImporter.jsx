...
export default function InvoiceImporter({ isOpen, onClose, existingArticles, onImportDone }) {
  ...
  const processText = (text) => {
    ...
    potentialLines.forEach((line, idx) => {
      ...
      // Find match by ref first (strongest) then by name substring
            ...
            <div style={{ height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center' }}>
              <div style={{ marginBottom: '32px', width: '100%', maxWidth: '400px' }}>
                ...
                >
                  ...
                  {[...new Set(existingArticles.map(a => a.supplierName))].map(s => (
